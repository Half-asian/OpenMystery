Shader "HDRP/Skinshader"
{
    Properties
    {
        ...
        //My shit
        u_colorMap("u_colorMap", 2D) = "white" {}
        u_secondaryMaps("u_secondaryMaps", 2D) = "white" {}
        u_specularity("u_specularity", Float) = 0.0
        u_specColor("u_specColor", Color) = (1,1,1,1)
        u_rimAngle("u_rimAngle", Float) = 0.0
        u_rimColor("u_rimColor", Color) = (1,1,1,1)
        alpha("alpha", Float) = 1.0
        u_flatness("u_flatness", Float) = 1.0
        u_shadeColor("u_shadeColor", Color) = (1,1,1,1)
        u_lightAngleBoost("u_lightAngleBoost", Float) = 1.0
...
SubShader
    ...
    Pass
    {
        ...
        #include "ShaderPassGBuffer.hlsl"

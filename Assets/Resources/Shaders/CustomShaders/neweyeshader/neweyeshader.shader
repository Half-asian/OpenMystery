Shader "HDRP/neweyeshader"
{
    Properties
    {
        ...
        //My shit
        u_diffuse("u_diffuse", 2D) = "white" {}
        u_mask("u_mask", 2D) = "white" {}
        u_diffuseColor("u_diffuseColor", Color) = (1,1,1,1)
        u_specColor("u_specColor", Color) = (1,1,1,1)
        u_specMinRadius("u_specMinRadius", Float) = 0.0
        u_specMaxRadius("u_specMaxRadius", Float) = 0.0
        u_topShadowStart("u_topShadowStart", Float) = 0.0
        u_topShadowEnd("u_topShadowEnd", Float) = 0.0
        u_sideShadowStart("u_sideShadowStart", Float) = 0.0
        u_sideShadowEnd("u_sideShadowEnd", Float) = 0.0
        alpha("alpha", Float) = 1.0
        u_flatness("u_flatness", Float) = 1.0
        u_AmbientLightSourceColor("u_AmbientLightSourceColor", Color) = (1,1,1,1)
        u_DirLightSourceDirection1("u_DirLightSourceDirection1", Vector) = (0.0,0.0,0.0,0.0)
        u_DirLightSourceDirection2("u_DirLightSourceDirection2", Vector) = (0.0,0.0,0.0,0.0)
        u_DirLightSourceDirection3("u_DirLightSourceDirection3", Vector) = (0.0,0.0,0.0,0.0)
        u_DirLightSourceDirection4("u_DirLightSourceDirection4", Vector) = (0.0,0.0,0.0,0.0)

        u_DirLightSourceColor1("u_DirLightSourceColor1", Color) = (1,1,1,1)
        u_DirLightSourceColor2("u_DirLightSourceColor2", Color) = (1,1,1,1)
        u_DirLightSourceColor3("u_DirLightSourceColor3", Color) = (1,1,1,1)
        u_DirLightSourceColor4("u_DirLightSourceColor4", Color) = (1,1,1,1)
...
SubShader
    ...
    Pass
    {
        ...
        //CustomEditor "Rendering.HighDefinition.SkinshaderGUI"
}